...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 Join our group!', url='https://t.me/bollywood_maniaaa')
            ],[
            InlineKeyboardButton('🔍Owner support', url='@itsssSoMe1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/movieuploader')
            ],[
